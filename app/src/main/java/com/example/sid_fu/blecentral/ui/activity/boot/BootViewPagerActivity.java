...
public class BootViewPagerActivity extends BaseActivity implements OnClickListener, OnPageChangeListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnStart.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(BootViewPagerActivity.this,LoginActivity.class);
