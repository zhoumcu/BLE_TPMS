...
import com.example.sid_fu.blecentral.model.ConfigValues;
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 0) {
                ...
                lowPressSeekBar.setProgress(ConfigValues.getLowPressProgress(device.getBackMinValues()));
                highPressSeekBar.setProgress(ConfigValues.getHighPressProgress(device.getBackmMaxValues()));
                highTempSeekBar.setProgress(ConfigValues.getLowTempProgress(device.getFromMinValues()));
            }else if(msg.what==2){
                ToastUtil.show("更新成功");
            }
        }
