...
public class MainActivity extends BaseActionBarActivity implements View.OnClickListener ,SensorEventListener {
...
//                    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Intent musicServiceIntent = new Intent(MainActivity.this, BluetoothLeStartService.class);
