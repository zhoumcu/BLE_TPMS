...
public class PersonSettingActivity extends BaseActionBarActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mContext = PersonSettingActivity.this;
...
//        manageDevice = new ManageDevice();
        findViewById(R.id.access).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PersonSettingActivity.this,PrivateActivity.class);
...
//        findViewById(R.id.bg_ground).setBackgroundDrawable(new BitmapDrawable(BitmapUtils.readBitMap(mContext,R.mipmap.g_bg)));
    ...
    public void setImgQcode() {
        ...
        intent.setClass(PersonSettingActivity.this, PictureView.class);
