 ...
 */
public class ConfigDevice extends BaseActionBarActivity implements View.OnClickListener{
            ...
            public void onClick(View v) {
                if(bottomleft_next.getText().equals("跳过"))
                {
                    ...
                    if(!firstTimeUse) {
                        ...
                        intent.setClass(ConfigDevice.this,HomeActivity.class);
...
//                mBluetoothAdapter.stopLeScan(mLeScanCallback);
    ...
    private Handler handler = new Handler()
    {
        ...
        public void handleMessage(Message msg) {
            ...
            isFirst = false;
            loadDialog.dismiss();
            Intent it =new Intent(ConfigDevice.this,NotifyDialog.class);
