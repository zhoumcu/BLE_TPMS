...
public class BarCodeTestActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.ericssonlabs.R.layout.main);

        resultTextView = (TextView) this.findViewById(com.ericssonlabs.R.id.tv_scan_result);
        qrStrEditText = (EditText) this.findViewById(com.ericssonlabs.R.id.et_qr_string);
        qrImgImageView = (ImageView) this.findViewById(com.ericssonlabs.R.id.iv_qr_image);

        Button scanBarCodeButton = (Button) this.findViewById(com.ericssonlabs.R.id.btn_scan_barcode);
        ...
        Button generateQRCodeButton = (Button) this.findViewById(com.ericssonlabs.R.id.btn_add_qrcode);
